    ...
    <div className="bg-emerald-600 container flex items-center justify-center h-screen mx-auto px-4 rounded-md relative overflow-hidden">
      <div className="hero flex flex-col md:flex-row w-full h-full relative z-10">
        <div className="left-hero flex flex-col justify-center items-start p-8 w-full md:w-1/2">
          ...
          <button className="bg-green-400 px-6 py-3 md:px-8 md:py-4 font-normal hover:font-semibold hover:text-lg rounded-md transition-all duration-500 ease-in-out">
            Get your quote now
          </button>
        </div>
