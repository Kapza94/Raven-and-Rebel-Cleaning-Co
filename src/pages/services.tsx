    ...
    <div className="container mt-10 mx-auto px-4 py-8 flex flex-col items-center bg-gray-100 rounded-lg">
      <div className="pt-5 pb-5 w-full bg-gray-300 rounded-lg">
        ...
        <div className="flex flex-wrap justify-around items-center mb-8">
          <div className="promo-item flex items-center justify-center mb-4 md:mb-0">
            <Image
              className="pr-2"
            ...
            <h3 className="text-xl font-extrabold">
              100+<span className="text-base font-light"> Houses cleaned</span>
            </h3>
          </div>
          <div className="promo-item flex items-center justify-center mb-4 md:mb-0">
            <Image
            ...
            />
            <h3 className="text-xl font-extrabold">
              50+<span className="text-base font-light"> Offices cleaned</span>
            </h3>
          </div>
          <div className="promo-item flex items-center justify-center mb-4 md:mb-0">
            <Image
            ...
            />
            <h3 className="text-xl font-extrabold">
              200+<span className="text-base font-light"> Happy Customers</span>
            </h3>
          </div>
          <div className="promo-item flex items-center justify-center">
            ...
            />
            <h3 className="text-xl font-extrabold">
              300+<span className="text-base font-light"> Custom Quotes Provided</span>
            </h3>
          </div>
        </div>
      </div>
